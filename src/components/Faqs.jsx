...
const faqs = [
  {
    ...
    answer:
      "Each person who intends to drive must bring a valid driver's license, and with a minimum of 2 years after the license was issued, passport, and a valid means of payment.",
  },
  {
    key: 2,
    question: "Do the cars have insurance?",
    answer:
      "We offer a rent a car insurance for people who want to be on the safe side.",
  },
  {
    key: 3,
  ...
  // },
  {
    ...
    answer:
      "We accept reservations for a rental period of 3 days at least.",
  },
];
